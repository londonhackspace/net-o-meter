...
import os, sys, time, logging, select, socket, textwrap, argparse
...
def set_logger():
    ...
    formatter = logging.Formatter('netometer[%(process)d]: %(levelname)-8s %(message)s')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--community', type=str, nargs=1, metavar=('<community>'),
      help='community name to use')
    
    args = parser.parse_args()

    logger = set_logger()

    logging.info("net-o-meter starting up.")    
